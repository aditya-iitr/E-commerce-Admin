...
- **Email Verification:** To ensure that no any randoms can register for admin i have created in such a way that only people with organisation email or g-suit can register (currently set to @gmail.com).
